...
export function ServiceHero({ title, titleHighlight, subtitle, bullets, rating = "5.0", rightSlot }: ServiceHeroProps) {
  return (
    <section
        ...
        <div className="grid lg:grid-cols-[1.5fr_1fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="text-center lg:text-left max-w-[760px] mx-auto lg:mx-0">
            <div className="mb-6 animate-fade-up">
              <GoogleReviewsBadge rating={rating} />
            </div>
            ...
            <p
              className="text-[15px] sm:text-[18px] text-white/60 leading-[1.6] mb-8 max-w-[620px] mx-auto lg:mx-0 animate-fade-up"
            ...
            <ul
              className="flex flex-wrap items-center justify-center lg:justify-start gap-x-5 gap-y-3 text-[13px] text-white/70 animate-fade-up"
          ...
          {/* Right — widget slot (defaults to lead form) */}
          {rightSlot ?? <LeadForm />}
